<div id="couponResultSection" style="display: none; background: #fff; width: 100%; border-top: 5px solid #667eea; padding: 20px 0; margin-top: 20px; box-shadow: 0 -5px 20px rgba(0,0,0,0.1);">
    <div class="container text-center">
        ...
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 15px; border-radius: 15px; color: white; display: inline-block; min-width: 300px; margin-bottom: 20px;">
            ...
            <p class="mb-0" style="font-size: 14px;">Kamu Mendapat Kupon Diskon!</p>
        </div>
